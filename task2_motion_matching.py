...
class Database():
    ...
    def extract_features(self, root_pos, root_rot, pos, rot, vel, avel):
        ...
        for feature_name in self.feature_names:
            ...
            elif feature_name == 'trajectoryPos2D': #rp, rr, bp, f
                features.append(self.extract_future_pos(root_pos, root_rot, pos[:, 0], frames = [20, 40, 60]))
            elif feature_name == 'trajectoryRot2D': #rr, br, f
                features.append(self.extract_future_rot(root_rot, rot[:, 0], frames = [20, 40, 60]))
...
def main():
    ...
    selected_feature_names = ['rKneeAVel', 'lKneeAVel', 'lFootRot', 'rFootRot', 'hipVel', 'trajectoryPos2D', 'trajectoryRot2D']
